...
# user_input: st.success(f"{user_input}")

# uploaded_files=st.file_uploader(f"{user_input} Upload your files (CSV or Excel):", type=["csv","xlsx"], accept_multiple_files=True)
# if uploaded_files:
